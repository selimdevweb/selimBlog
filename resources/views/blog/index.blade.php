...
{{-- coindition pour afficher un message de confirmation  --}}
...
<div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
    ...
    <div>
        ...
        <span class="text-gray-500">
            Par  <span class=" font-bold italic text-gray-800">{{ $post->user->name }}, Créé le {{ date('jS M Y',
            strtotime($post->updated_at)) }}</span>
        </span>

        <p class="text-xl text-gray-600 pt-8 pb-10 leading-8 font-light">
            {{ $post->description }}
        </p>
        ...
        <span class="float-right">
            <a
            class=" text-gray-700 italic hover:text-gray-900 pb-1"
